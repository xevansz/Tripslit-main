...
export default function Home() {
  ...
  const activity = [
    ...
    },
    {
      ...
      label: "Sam settled $120 with you",
      time: "Yesterday",
    ...
    },
    {
      id: "a3",
      icon: "notifications",
      label: "Bali trip reminder: book ATV",
      time: "2d ago",
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <View style={{ flexDirection: "row", gap: 10 }}>
            <TouchableOpacity
              testID="home-ai-shortcut"
              onPress={() => router.push("/(tabs)/tripbuddy")}
            ...
            <View style={styles.balRow}>
              <View style={styles.balPill}>
                ...
                <View>
                  ...
                  <Text style={styles.pillBottom}>
                    ${bal.you_owe.toFixed(2)}
                  </Text>
                </View>
              </View>
              <View style={styles.balPill}>
        ...
        <View style={styles.qaRow}>
          ...
          <Quick
            ...
            label="Scan QR"
            color={"#8B5CF6"}
            onPress={() => router.push("/grouppay/scan")}
            testID="qa-scan"
          />
          <Quick
            icon="alert-circle"
        ...
        <View style={styles.section}>
          ...
          {activeTrip ? (
            ...
            >
              <ImageBackground
                source={{ uri: activeTrip.cover_image }}
                style={styles.tripCard}
                imageStyle={{ borderRadius: 24 }}
              >
                <LinearGradient
                  colors={["transparent", "rgba(0,0,0,0.7)"]}
                  style={[StyleSheet.absoluteFill as any, { borderRadius: 24 }]}
                />
                  ...
                  <View style={styles.avatarsRow}>
                    {(activeTrip.members || [])
                      ...
                      .map((m: any, i: number) => (
                        <View
                          key={i}
                          style={[styles.miniAvatar, { left: i * -12 }]}
                        >
                          <Text
                            style={{
                              color: "#fff",
            ...
            <TouchableOpacity
              testID="home-no-trip-cta"
              onPress={() => router.push("/trip/create")}
              style={styles.emptyTrip}
            >
              <Ionicons name="add" size={28} color={colors.primary} />
              <Text style={styles.emptyTitle}>Start your first trip</Text>
              <Text style={styles.emptySub}>
                Plan, split & travel with your crew.
              </Text>
            </TouchableOpacity>
          )}
        </View>
                ...
                >
                  ...
                  <View style={styles.recOverlay}>
                    <View style={styles.recTag}>
                      <Text style={styles.recTagT}>{r.tag}</Text>
                    </View>
                    <Text style={styles.recT} numberOfLines={2}>
                      {r.title}
                    </Text>
                    <View style={styles.matchRow}>
                      <Ionicons name="sparkles" size={11} color="#fff" />
                      <Text style={styles.matchT}>{r.match}% match</Text>
                    </View>
                  </View>
                </TouchableOpacity>
              ))}
          ...
          <Card style={{ marginTop: 12, padding: 0 }}>
            {activity.map((a, i) => (
              <View
                ...
                style={[
                  styles.actRow,
                  i < activity.length - 1 && styles.actRowBorder,
                ]}
              >
                <View
                  style={[styles.actIcon, { backgroundColor: a.color + "22" }]}
                >
